  ...
  return (
    <ul className="app-footer">
      ...
      <li className="app-footer__item app-footer__item--contact">
        <a className="app-footer__contact-link app-footer__contact-link--message" href="tel:*0904">
      ...
      <li className="app-footer__item app-footer__item--contact">
        <a className="app-footer__contact-link app-footer__contact-link--phone" href="tel:+78001112233">
        ...
        <p className="app-footer__message-text app-footer__message-text--phone">Бесплатный для всех городов России</p>
      </li>
      <li className="app-footer__item">
